...
export function EditProductionOrderPageContent({ orderId }: { orderId?: string } = {}) {
  ...
  return <ProductionOrderForm order={order} onSaved={(saved) => router.push(productionOrderDetailHref(saved.id))} />;
}

export default function EditProductionOrderPage() {
  return <EditProductionOrderPageContent />;
}
